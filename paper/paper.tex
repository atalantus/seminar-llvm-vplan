...
Finally, some instructions, such as integer division, do inherently not have a vectorized instruction equivalent.
...
control-flow graph and its components are the main elements of a single VPlan.
...
Upon execution, the H-CFG of the VPlan is walked, and each node is executed, which executes all 
