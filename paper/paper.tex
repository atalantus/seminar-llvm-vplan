...
In its current state (LLVM 19.1.4) VPlan is deeply integrated into LV. To better understand the
current structure of a VPlan, modelling a certain vectorization approach, we will use the
...
Outer loop vectorization support for VPlan is still experimental, seperated from the inner loop
