...
% TODO: Explain contents of both figures better
...
\begin{itemize}
  ...
  % TODO: Explain some instructions more in detail (e.g. CANONICAL-INDUCTION, SCALAR-STEPS)
\end{itemize}
...
% TODO: VPlan Transformations example
...
% TODO: Connect better to previous phase (expand a bit on how the legality artifacts are used when planning)
...
compile target.
% TODO: Expand on this and explain a bit more
...
% TODO: How exactly is the translation from VP recipe back to LLVM IR working? Where does the target
%       backend come in to decide what actual instruction?
